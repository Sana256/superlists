...
class HomePageTest(TestCase):
    ...
    def test_uses_home_templatel(self):
...
class ListViewTest(TestCase):
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(f'/lists/{correct_list.id}/', data={'text': 'A new item to existing list'})
    ...
    def test_for_invalid_inputs_renders_list_template(self):
        response = self.post_invalid_input()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'list.html')

    def test_for_invalid_inputs_passes_form_to_template(self):
        response = self.post_invalid_input()
        self.assertIsInstance(response.context['form'], ExistingListItemForm)

    def test_for_invalid_inputs_shows_errors_on_page(self):
        response = self.post_invalid_input()
...
class NewListTest(TestCase):
    ...
    def test_invalid_list_items_arent_saves(self):
